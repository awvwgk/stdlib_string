...
module test_ftlstring
    ...
    abstract interface
        !> Actual tester working on a str type and a fixed length character
        ...
        !> Actual tester working on two pairs of str type and fixed length
...
contains
    ...
    subroutine constructor_check2(chr1, chr2, checker)
        character(len=*), intent(in) :: chr1, chr2
        procedure(check2_interface) :: checker
        call checker(string(chr1), chr1, string(chr2), chr2)
    ...
    subroutine mixed_check2(chr1, chr2, checker)
        ...
        str1 = chr1
        str2 = chr2
        call checker(str1, chr1, string(chr2), chr2)
        call checker(string(chr1), chr1, str2, chr2)
    ...
    subroutine test_len
        ...
        str = "Some longer sentence for this example."
        length = len(str)
        ...
        call check1("Example str", gen_len)
    ...
    subroutine test_len_trim
        ...
        call check1("Example str", gen_len_trim)
    ...
    subroutine test_adjustl
        ...
        str = "                            Whitespace"
        str = adjustl(str)
        call check(char(str) == "Whitespace                            ")
    ...
    !> Generator for checking the substring search in a character str
    ...
    subroutine test_char
        ...
        dlc = char(str, 3)
        call check(dlc == "a")
        chars = char(str, [3, 5, 8, 12, 14, 15, 18])
    ...
    subroutine test_listdirected_io
        ...
        read(io, *, iostat=stat) str
        close(io)

        call check(stat == 0)
        call check(len(str) == 21)
        call check(str == "Important saved value")
    ...
    subroutine test_assignment
        ...
        call check(len(str) == 0)

        str = "Sequence"
        call check(len(str) == 8)

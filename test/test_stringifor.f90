...
module test_ftlstring
    ...
    use stringifor_string_t, string_ => string
    implicit none
    ...
    abstract interface
        ...
        subroutine check2_interface(str1, chr1, str2, chr2)
            import :: string_
            type(string_), intent(in) :: str1, str2
...
contains
    ...
    subroutine constructor_check1(chr1, checker)
        character(len=*), intent(in) :: chr1
        procedure(check1_interface) :: checker
        call checker(string_(chr1), chr1)
    ...
    subroutine constructor_check2(chr1, chr2, checker)
        character(len=*), intent(in) :: chr1, chr2
        procedure(check2_interface) :: checker
        call checker(string_(chr1), chr1, string_(chr2), chr2)
    ...
    subroutine mixed_check2(chr1, chr2, checker)
        character(len=*), intent(in) :: chr1, chr2
        type(string_) :: str1, str2
        procedure(check2_interface) :: checker
        str1 = chr1
        str2 = chr2
        call checker(str1, chr1, string_(chr2), chr2)
        call checker(string_(chr1), chr1, str2, chr2)
    ...
    subroutine test_trim
       type(string_) :: string, trimmed_str

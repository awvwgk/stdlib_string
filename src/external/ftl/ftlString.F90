...
! This implementation of ftlString is based on the Fortran stdlib string_class.
...
! ====== Type of the ftlString container itself ==================================================================================
   ...
   type, extends(string_class), public :: ftlString
      private
   ...
   contains
      ...
      procedure, public :: assign_object_char
      ...
      procedure, public :: get_len_trim
      !> Return the character sequence represented by the string.
      procedure, public :: get_char
      !> Return the character sequence represented by the string.
      procedure, public :: get_char_pos
      !> Return the character sequence represented by the string.
      procedure, public :: get_char_range
...
contains
   ...
   ! ====== Implementation of string_class methods =====================================================================================
   !> Assign a character sequence to a string object.
   elemental subroutine assign_object_char(lhs, rhs)
      class(ftlString), intent(inout) :: lhs

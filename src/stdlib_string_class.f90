...
module stdlib_string_class
    ...
    contains
        ...
        procedure(assign_object_char_interface), deferred :: assign_object_char
        ...
        !> Returns the length of the character sequence represented by the string.
        procedure(get_int_interface), deferred :: get_len

        !> Returns the length of the character sequence without trailing spaces
        !> represented by the string.
        procedure(get_int_interface), deferred :: get_len_trim
        ...
        !> Return the character sequence represented by the string.
        procedure(get_char_interface), deferred :: get_char

        !> Return the character sequence represented by the string.
        procedure(get_char_pos_interface), deferred :: get_char_pos

        !> Return the character sequence represented by the string.
        procedure(get_char_range_interface), deferred :: get_char_range
        ...
        generic, public :: operator(.gt.) => gt_object_object, gt_object_string, &
        ...
        generic, public :: operator(.lt.) => lt_object_object, lt_object_string, &
        ...
        generic, public :: operator(.ge.) => ge_object_object, ge_object_string, &
        ...
        generic, public :: operator(.le.) => le_object_object, le_object_string, &
        ...
        generic, public :: operator(.eq.) => eq_object_object, eq_object_string, &
        ...
        generic, public :: operator(.ne.) => ne_object_object, ne_object_string, &
